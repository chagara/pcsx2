...
{
	m_SourceFilename[static_cast<uint8_t>(srctype)] = newfile;
...
{
	return m_SourceFilename[static_cast<uint8_t>(srctype)];
}
...
bool DoCDVDopen()
{
	...
	uint8_t CurrentSourceType = static_cast<uint8_t>(m_CurrentSourceType);
